...
-(void)ApplyOrder:(NSString *)OrderId RefundType:(NSString *)RefundType RefundReason:(NSString *)RefundReason RefundRemark:(NSString *)RefundRemark Images:(NSArray *)Images success:(SuccessBlock)success failure:(FailureBlock)faileure{
    AFHTTPSessionManager *manager = [self baseHtppRequest];
    [manager.requestSerializer setValue:TOKEN forHTTPHeaderField:X_CLIENT_TOKEN];
