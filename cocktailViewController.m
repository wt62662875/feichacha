...
#import "cocktailCollectionViewCell.h"
#import "baseViewController.h"
#import "cocktailHeadCollectionReusableView.h"
...
{
    static NSString * CellIdentifier = @"cocktailCollectionViewCell";
    cocktailCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
    ...
    cell.buyButton.backgroundColor = RGBCOLORA(238, 95, 86, 1);
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    cocktailHeadCollectionReusableView *headView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"cocktailHeadCollectionReusableView" forIndexPath:indexPath];
    [headView.headImage sd_setImageWithURL:[NSURL URLWithString:@"http://manage.feichacha.com/html/shop/images/index_yl_banner.jpg"] placeholderImage:[UIImage imageNamed:@"banner"]];
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section{
    CGSize size = {SCREENWIDTH,SCREENWIDTH*0.563};
    return size;
}
...
-(void)cellBuyButton:(UIButton *)sender{
    ...
    cocktailCollectionViewCell *cell = (cocktailCollectionViewCell *)[_collectionView cellForItemAtIndexPath:indexpath];
