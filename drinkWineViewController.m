...
#import "drinkWineCollectionViewCell.h"
#import "drinkWineHeadCollectionReusableView.h"
#import "drinkWineBannerCollectionReusableView.h"
#import "baseViewController.h"

@interface drinkWineViewController ()
{
...
@implementation drinkWineViewController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[drinkWineBannerCollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"drinkWineBannerCollectionReusableView"];
...
-(void)ActivityListDatas{
    ...
    [[NetworkUtils shareNetworkUtils] ActivityList:[_getDatas objectForKey:@"Id"] ActType:[_getDatas objectForKey:@"ActType"] success:^(id responseObject) {
        ...
        if ([[responseObject objectForKey:@"ResultType"]intValue] == 0) {
            ...
            classHeadViewY1 = SCREENWIDTH*0.59;
            if (datas1.count %2 == 0) {
...
{
    static NSString * CellIdentifier = @"drinkWineCollectionViewCell";
    drinkWineCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
    cell.layer.borderWidth = 1;
    cell.layer.borderColor = RGBCOLORA(73, 184, 255, 1).CGColor;
    ...
    cell.buyButton.backgroundColor = RGBCOLORA(73, 184, 255, 1);
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (kind == UICollectionElementKindSectionHeader){
        if (indexPath.section == 0) {
            drinkWineBannerCollectionReusableView * headView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"drinkWineBannerCollectionReusableView" forIndexPath:indexPath];
            UIImageView *tempImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENWIDTH*0.59)];
            [tempImage sd_setImageWithURL:[NSURL URLWithString:@"http://manage.feichacha.com/html/shop/images/yl_banner.jpg"]];
            [headView addSubview:tempImage];
            
            reusableview = headView;
        }else{
            drinkWineHeadCollectionReusableView * headView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"drinkWineHeadCollectionReusableView" forIndexPath:indexPath];
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section{
    if (section == 0) {
        CGSize size = {SCREENWIDTH,SCREENWIDTH*0.59+70};
        return size;
    }else{
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (point.y >= SCREENWIDTH*0.59) {
        frame.origin.y = 64;
    }else{
        frame.origin.y = SCREENWIDTH*0.59+64 - point.y;
    }
    navigationView.frame = frame;
    
    [navButton1 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];
    [navButton2 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];
    [navButton3 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];
    [navButton4 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];
    [navButton5 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];
    [navButton6 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];
    [navButton7 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];
    [navButton8 setBackgroundColor:RGBCOLORA(73, 184, 255, 1)];

    if (point.y >= classHeadViewY1 && point.y < classHeadViewY2) {
        [navButton1 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }else if (point.y >= classHeadViewY2 && point.y < classHeadViewY3){
        [navButton2 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }else if (point.y >= classHeadViewY3 && point.y < classHeadViewY4){
        [navButton3 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }else if (point.y >= classHeadViewY4 && point.y < classHeadViewY5){
        [navButton4 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }else if (point.y >= classHeadViewY5 && point.y < classHeadViewY6){
        [navButton5 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }else if (point.y >= classHeadViewY6 && point.y < classHeadViewY7){
        [navButton6 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }else if (point.y >= classHeadViewY7 && point.y < classHeadViewY8){
        [navButton7 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }else if (point.y >= classHeadViewY8 ){
        [navButton8 setBackgroundColor:RGBCOLORA(53, 160, 228, 1)];
    }
    
}

-(void)initNavigationView{
    navigationView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREENWIDTH*0.59+64, SCREENWIDTH, 78)];
    ...
    [navButton2 setTitle:@"饮用水" forState:UIControlStateNormal];
    ...
    [navButton3 setTitle:@"碳酸饮料" forState:UIControlStateNormal];
    ...
    [navButton4 setTitle:@"果蔬饮料" forState:UIControlStateNormal];
    ...
    [navButton5 setTitle:@"植物蛋白" forState:UIControlStateNormal];
    ...
    [navButton6 setTitle:@"茶饮/咖啡" forState:UIControlStateNormal];
    ...
    [navButton7 setTitle:@"功能饮料" forState:UIControlStateNormal];
...
-(void)buyButton:(UIButton *)sender{
    ...
    drinkWineCollectionViewCell *cell = (drinkWineCollectionViewCell *)[_collectionView cellForItemAtIndexPath:indexpath];
